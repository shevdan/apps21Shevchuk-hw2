...
public class ImmutableLinkedListTest {
    private ImmutableLinkedList test_arr, test_arr2;
    ...
    public void testAdd() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.add(4);
    ...
    public void testClear() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.clear();
    ...
    public void testIsEmpty() {
        ...
        test_arr2 = new ImmutableLinkedList();
    ...
    public void addFirst() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.addFirst(0);
        assertEquals("0 1 2 3 ", test_arr2.toString());
        assertEquals("1 2 3 ", test_arr.toString());
    ...
    public void addLast() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.addLast(0);
        assertEquals("1 2 3 0 ", test_arr2.toString());
        assertEquals("1 2 3 ", test_arr.toString());
    }
    ...
    public void getHead() {
        test_arr = new ImmutableLinkedList(arr);
        assertEquals(1, test_arr.getHead().getValue());
        test_arr = new ImmutableLinkedList();
        assertEquals(null, test_arr.getHead());
    }

    @Test
    public void getTail() {
        test_arr = new ImmutableLinkedList(arr);
        assertEquals(3, test_arr.getTail().getValue());
        test_arr = new ImmutableLinkedList();
        assertEquals(null, test_arr.getTail());
    }

    @Test
    public void getFirst() {
        test_arr = new ImmutableLinkedList(arr);
        assertEquals(1, test_arr.getFirst());
        test_arr = new ImmutableLinkedList();
        assertEquals(null, test_arr.getFirst());
    }

    @Test
    public void getLast() {
        test_arr = new ImmutableLinkedList(arr);
        assertEquals(3, test_arr.getLast());
        test_arr = new ImmutableLinkedList();
        assertEquals(null, test_arr.getLast());
    }

    @Test
    public void removeFirst() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.removeFirst();
        assertEquals("2 3 ", test_arr2.toString());
        assertEquals("1 2 3 ", test_arr.toString());
    ...
    public void removeLast() {
        test_arr = new ImmutableLinkedList(arr);
        test_arr2 = (ImmutableLinkedList) test_arr.removeLast();
        assertEquals("1 2 ", test_arr2.toString());
        assertEquals("1 2 3 ", test_arr.toString());
